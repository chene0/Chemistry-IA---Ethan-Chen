...
\begin{center}
    ...
    sodium bentonite clay swells and the mixed solution's concentration of hydrochloric acid (\ce{HCl}) /\unit{mol.dm^{-3}}?
    \\
\end{center}
...
surrounding the various unintuitive factors that can
result in the failure of a structure.
For instance, when my father was discussing the various
...
the factor by which the volume of
sodium bentonite swells and the concentration of hydrochloric acid (\ce{HCl})
in a separate solution /\unit{mol.dm^{-3}} when the \ce{HCl} solution and sodium bentonite
mix?"
...
then the degree of clay swelling is reduced \cite{ramavaraprasadSwellingCharacteristicsSoils2018a}.
...
the clay and solution to be mixed at a 1:10 ratio of volume.
...
best maximum \ce{[HCl]} to see the optimal holistic result
in the relationship between the factor of swelling and \ce{[HCl]}.
...
the factor by which the volume of
sodium bentonite swells will decrease as the concentration of \ce{HCl} of the mixed
...
of swelling as a function of \ce{[HCl]}.
...
\begin{paracol}{2}
    ...
    Inconsistent durations of time between trials will result
    in the clays of some trials undergoing excessive swelling
    from the additional time given to swell.
    Note that in the process, there will be a slight difference in duration
    allowed between the 5 trials that share the same \ce{[HCl]}.
    ...
    trials will lead to major differences of the amount of \ce{H+} ions available to
...
to clean out of a thin graduated cylinder, it is best to
...
is associated with the set volume of clay.
\subsubsection{Why it must be controlled}
Differing the volume of initial clay between trials will lead to
major differences in \ce{Na+} ions present in the clay. This will
...
\begin{paracol}{2}
    ...
    \begin{itemize}
        ...
        \item Take caution when attaching/detaching a pipette pump onto/from a pipette, ensuring that the distance between the two hands do not apply overwhelming torque onto the pipette.
    \end{itemize}
\end{paracol}
...
\begin{enumerate}
    ...
    \item Handwash thoroughly after the experiment and clean the laboratory workspace
\end{enumerate}
...
\begin{outline}
    ...
    \1 The hydrochloric acid is a clear colourless solution for all \ce{HCl} concentrations used in this experiment
    ...
    \2 The submerged clay releases black solids resembling watermelon seeds
...
\begin{table}[H]
    \fontsize{9pt}{9pt}\selectfont
    \centering
    \caption{The uncertainty of the factor of swelling per trial for each concentration of \ce{HCl}}
    \label{tab:unc}
    \begin{tblr}{
        cells = {c},
        cell{1}{1} = {r=2}{},
...
Plotting the processed data of Table \ref*{tab:finalizedFactor}
results in the graph in Figure \ref*{fig:procDataRaw}.
...
\textit{Note: the exclusion of \(\ce{[HCl]} = 0\) is necessary
    to allow Excel to generate the reciprocal trendline}.
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\linewidth]{exponential.png}
...
% All literature data concentrations converted into \unit{mol.dm^{-3}}
% can then be compared to swelling percentage as seen in Table \ref*{tab:literature}.
...
\begin{paracol}{2}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\linewidth]{literature.png}
...
Graphing the processed literature data from \ref*{tab:literature} produces the graph in Figure \ref*{fig:procLiterature},
...
\begin{paracol}{2}
    \begin{figure}[H]
        ...
        \caption{Swelling percentage /\% as a function of concentration of \ce{H3O+} ions in solution from literature data \protect\cite{ramavaraprasadSwellingCharacteristicsSoils2018a}}
    ...
    \begin{figure}[H]
        ...
        \caption{Natural logarithm of factor of swelling converted from swelling percentage as a function of concentration of \ce{H3O+} ions in solution from literature data \protect\cite{ramavaraprasadSwellingCharacteristicsSoils2018a}}
...
\begin{paracol}{2}
    ...
    \begin{figure}[H]
        ...
        \caption{Reciprocal of swelling percentage as a function of [\ce{H3O+}] from literature data \protect\cite{ramavaraprasadSwellingCharacteristicsSoils2018a}}
...
and a solution's concentration of \ce{HCl} /\unit{mol.dm^{-3}}
when the acidic solution and bentonite mix is inversely proportional
(\(F \propto \frac{1}{\ce{[HCl]}}\)). Confidence in the
results of this investigation is justifiable by the
similarities between the experimental data seen in
Figure \ref*{fig:reciprocal} and the literature data seen
in Figure \ref*{fig:procLiterature}.
...
Despite the sources of error discussed in Table \ref*{tab:soe}, the methodology and process in this
investigation allows for simple experimentation surrounding
clay swelling. Overall, without consideration of the last experimental data point
...
\begin{table}[H]
    \centering
    \caption{Discussion of sources of error in the experiment}
    \label{tab:soe}
    \begin{tblr}{
        width = \linewidth,
